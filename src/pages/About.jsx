  ...
  return (
    <div className="bg-white">
      ...
      <div className="flex justify-center pt-6">
        {/* Prefer a local file placed at /public/logo.png; or swap to your hosted URL */}
        <img src="/logo.png" alt="HaggleHub" className="h-12 object-contain" />
      </div>
      ...
      <div className="relative isolate px-6 pt-10 lg:px-8">
        ...
        >
          <div
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#5EE83F] to-[#0f766e] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
            style={{
              clipPath:
          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link to={createPageUrl('Dashboard')}>
                <Button className="bg-brand-teal hover:bg-brand-teal-dark text-white font-bold">
                  Get Started
                </Button>
              </Link>
            </div>
