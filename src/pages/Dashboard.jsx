  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        // Fetch all protected data since user is authenticated
        const [dealData, vehicleData, dealerData, messageData] = await Promise.all([
        ...
        console.error("User not authenticated, redirecting to landing page");
        navigate('/');
        return;
      } finally {
        setIsLoading(false);
